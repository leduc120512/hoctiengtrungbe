...
/**
 * Dữ liệu cập nhật toàn phần một từ vựng (chỉ quản trị viên được dùng).
 *
 * <p>Quy ước: {@code topicIds} và {@code examples} nếu khác null sẽ THAY THẾ
 * toàn bộ tập hiện có; nếu để null thì giữ nguyên dữ liệu cũ.</p>
 */
public record UpdateWordRequest(
        ...
        /** Nếu khác null: thay thế toàn bộ danh sách chủ đề của từ. */
        Set<Long> topicIds,

        /** Nếu khác null: thay thế toàn bộ danh sách câu ví dụ của từ. */
